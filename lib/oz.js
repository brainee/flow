...
var OZ = {
    ...
    DOM:{
        ...
        scroll:function() { 
//          var x =parent.document.documentElement.offsetLeft || parent.document.body.offsetLeft || 0;
//          var y = parent.document.documentElement.offsetTop || parent.document.body.offsetTop || 0;
        ...
        win:function() {
            var node = (parent.document.compatMode == "CSS1Compat" ? parent.document.documentElement : parent.document.body);
            if (OZ.opera && parseFloat(navigator.appVersion) < 9.5) { node = parent.document.body; }
    ...
    Request:function(url, callback, options) {
        ...
        if (o.method == "POST") { xhr.setRequestHeader("Content-Type","application/x-www-form-urlencoded;charset=utf-8"); }
